...
export default {
  ...
  mounted() {
    ...
    let fontColorType = "";
    let lottieItem = {
      typeGreen: [{ path: "/json/gut_greennn.json" }],
      typeWhite: [{ path: "/json/gut_white.json" }],
    };
    ...
    if (fontColorType == "green") {
      lottiePath =
        lottieItem.typeGreen[
          Math.floor(Math.random() * lottieItem.typeGreen.length)
        ].path;
    } else if (fontColorType == "white") {
      lottiePath =
        lottieItem.typeWhite[
          Math.floor(Math.random() * lottieItem.typeWhite.length)
        ].path;
    }
