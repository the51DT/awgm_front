<template>
  <!-- 챌린지 팀 관리 -->
  <div class="team--sub" v-if="allTimes == false">
    ...
    <div class="terms-tab">
      ...
      <div class="terms-tab__cont">
        ...
        <div class="card card--pl8 card--shadow00 team--sub__team-rate-ranking">
        ...
        <div class="card card--p20 card--shadow00 team--sub__card-team-info">
          <dl>
            <dt>팀 구분</dt>
            <dd><p class="card__title"> 챌린지 </p></dd>
          </dl>
          <dl>
            <dt>전체 기간</dt>
            <dd>
  ...
  <div class="team--sub" v-else>
    ...
    <!-- <div class="team--sub__title">
      <p class="title__big">GUT Morning Korea Challenge 상시상세</p>
      <p class="title__main"><i> 팀명 </i> 아침마다 오 마이 GUT Morning</p>
      <div class="title__date">
        <p>3회차 진행중</p>
        <p>2025.04.01~2025.06.10 / 70일</p>
      </div>
    </div> -->
    <!-- <div class="card card--p20 card--shadow00 team--sub__card-rank">
      <p class="card-rank-title">챌린지 랭킹</p>
      <div class="card__display-rank">
        <p><span> 5 </span>위</p>
        <button type="button">
          팀 랭킹 보기
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      setTimeout(() => {
        ...
        console.log("targetSection:", target); // 이게 null이면 아직도 안된 것
        if (!target) return;
