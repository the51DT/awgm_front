...
export default {
  ...
  data() {
    return {
      ...
      rightArea: "",
      card_profile: [
        { id: 1, nick: "팀장 김웨이", name: "김*이", img: 'card_profile_1.png', count: '999', rate: '99', isLeader: true, accreditABO: true, },
        { id: 2, nick: "유리카", name: "김*** 유리카 닉슨", img: 'card_profile_2.png', count: '223', rate: '74', isLeader: false, accreditABO: false, },
