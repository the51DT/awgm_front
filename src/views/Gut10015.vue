      ...
      <div class="profile-area small">
        ...
        <div class="text-wrap">
          <div class="text-wrap-default" v-if="default">
            ...
            <button @click="onEdit" type="button" class="btn-modify" title="프로필명 변경"><span class="blind">프로필명
                변경</span></button>
          </div>
        ...
        <div class="my-page-conts-item">
          ...
          <div class="card card--shadow00">
            <div class="text-box-wrap">
              ...
              <ul class="sub-wrap">
                <li>
                  <CustomButton size="sm" color="light">인증완료</CustomButton>
                </li>
              </ul>
              <!-- //인증 후 case -->
            </div>
          ...
          <div class="card-group">
            ...
            <div class="card card--shadow00">
              <div class="text-box-wrap">
                ...
                <ul class="sub-wrap">
                  <li>
                    <CustomButton size="sm">연동하기</CustomButton>
                  </li>
                </ul>
              </div>
            </div>
