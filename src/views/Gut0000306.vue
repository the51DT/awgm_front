      ...
      <div class="box-wrap">
        <div class="box-gray">
          <div class="terms-conts">
            ...
            [필수 제공 항목] 아이디, 닉네임, 인증 횟수, 인증 사진, 접속로그, 쿠키 (Cookie)<br/>
            [제공목적]  Gut Morning 서비스 내 이용자 식별 및 회원관리, 각종 서비스 관련 편의, 혜택 제공 및 고지사항 전달, 것모닝 서비스 내 부모 대시보드 운영 및 부모의 자녀 활동 관리<br/>
